                ...
                <div className="flex flex-col items-center gap-10 pt-36 pb-20">
                    ...
                    <div className="text-center space-y-4 max-w-2xl">
                        ...
                        <p className="text-sm text-gray-200">
                            Únete a nuestro programa de afiliados y comienza a generar ingresos con Rendaz. 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-4xl w-full">
                        ...
                        <div className="flex flex-col items-start gap-4 rounded-3xl border border-[#2e2e2e] bg-[#141414] p-6">
                            ...
                            <p className="text-sm text-gray-300">
                                Compra cuentas verificadas a precio mayorista y véndelas directamente en tu comunidad, redes sociales o contactos. 
                                Controla tus márgenes y escala tu negocio digital.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-start gap-4 rounded-3xl border border-[#2e2e2e] bg-[#141414] p-6">
                            ...
                            <p className="text-sm text-gray-300">
                                Haz crecer tu dinero invirtiendo directamente en Rendaz. Nosotros nos encargamos de la compra y venta de cuentas, 
                                y tú obtienes beneficios por tu inversión.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center space-y-4 max-w-2xl mt-12">
                        ...
                        <p className="text-sm text-gray-200">
                            Escríbenos por WhatsApp y te explicamos cómo empezar como afiliado, los requisitos y los beneficios.
                        </p>
                    </div>
